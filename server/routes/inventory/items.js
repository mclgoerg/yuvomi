...
function validateItemFields(body) {
  ...
  // Manuelle Kilometerstand-Ablesung (Proposal 5) - bewusst auf die Kategorie
  // "Fahrzeuge" begrenzt (Nutzer-Entscheidung 2026-09-17, keine Ausweitung auf
  // andere Kategorien). Fuer jede andere Kategorie wird still auf NULL
  ...
  // weg von Fahrzeugen raeumt einen vorher gesetzten Wert automatisch ab, statt
  // ihn unsichtbar (das Formular blendet das Feld dann aus) stehen zu lassen.
