...
function makeDb() {
  ...
  db.exec(`
    CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE NOT NULL,
      ...
      -- D6 (Package B): der Subjekt-Name auf der geerbten Vorsorge-Erinnerung
    ...
    -- processDueNotifications() UND fuer syncAllPreventionReminders() (Package B) -
    ...
    CREATE TABLE reminders (
      ...
      -- D6-Betreuungs-Fan-out (Package B): processDueNotifications() selektiert
